        ...
        <el-table-column label="成年猫">
            <el-table-column label="最低" prop="refMin2">
              <template scope="scope">
                    ...
                    <template v-else>
                      <el-input v-model="scope.row.refMin2" placeholder="" type="number" step="0.01"></el-input>
                    </template>
                  </template>
            </el-table-column>
            <el-table-column label="最高" prop="refMax2">
              <template scope="scope">
                    ...
                    <template v-else>
                      <el-input v-model="scope.row.refMax2" placeholder="" type="number" step="0.01"></el-input>
                    </template>
                  </template>
            </el-table-column>
          </el-table-column>
        <el-table-column label=">8年">
          <el-table-column label="最低" prop="refMin3">
            <template scope="scope">
                    ...
                    <template v-else>
                      <el-input v-model="scope.row.refMin3" placeholder="" type="number" step="0.01"></el-input>
                    </template>
                  </template>
          </el-table-column>
          <el-table-column label="最高" prop="refMax3">
            <template scope="scope">
                    ...
                    <template v-else>
                      <el-input v-model="scope.row.refMax3" placeholder="" type="number" step="0.01"></el-input>
                    </template>
                  </template>
          </el-table-column>
        </el-table-column>
