<template>
  <div >
    ...
    <div class="moni-content">
      <div class="chaxun-dialog" >
        <bingli2 v-if="caseId" :id="caseId" :hideResult="true" ></bingli2>
        <div class="chaxun-dialog-content">
          <el-form >
            <el-form-item label="确诊疾病">
              <el-input placeholder="" v-model="diagDisease"></el-input>
    ...
    <el-dialog title="模拟病例学习" :visible.sync="visible" width="1300px" show-close>
      <div class="moni-content">
        ...
        <div class="chaxun-dialog" style="margin-left: 10px">
          <bingli3 v-if="caseId" :id="caseId" :hideResult="true" ></bingli3>
          <div class="chaxun-dialog-content">
            <el-form >
              <el-form-item label="确诊疾病">
                {{diagDisease}}
        ...
        <div class="chaxun-dialog" style="margin-left: 10px">
          <bingli1 v-if="caseId" :id="caseId" ></bingli1>
        </div>
      </div>
...
<script>
  ...
  import bingli1 from '../../../components/bingli1.vue'
  import bingli2 from '../../../components/bingli2.vue'
  import bingli3 from '../../../components/bingli3.vue'
  import api from '../api'
  export default {
    props: {
